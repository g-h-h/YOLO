<template>
    <view class="calendar-wrapper">
        ...
        <view :class="{ hide: !monthOpen }" class="content" v-if="hackReset" :style="{ height: height }">
            <view :style="{ top: positionTop + 'rpx' }" class="days">
                <view class="item" v-for="(item, index) in dates" :key="index">
                    ...
                    >
                        {{ Number(item.date) }}
					<QSAnimation animationType="pendant" @touchmove="tap">
					    <view class="box" >
							
							<pic :date="`${item.year}-${item.month}-${item.date}`"></pic>
					    </view>
					</QSAnimation>	
                    </view>
